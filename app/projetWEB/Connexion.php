<html>
	<head>
		...
		<link href="css/Connexion1.css" rel="stylesheet">
    ...
    <body>
        <form method="post" action="Connexion.php">
			...
			<div class=center>
				<input type="submit" class=boutonclass name="Soumettre" id=Connexion value="Connexion"/>
					
				
				<input type="button" class=boutonclass name="Inscription" id=Inscription value="Inscription" OnClick="location.href='Inscription.php'"/>
				</br><label class=inscription>Si c'est votre première fois sur ce site, veuillez sélectionner le bouton d'inscription</label>
			</div>
			</fieldset>
        </form>
    </body>
