...
<menu>
<link href="css/PublicationAjoutEvent1.css" rel="stylesheet">
<div id="menu">
  <ul id="onglets">
...
<input type="Submit" class="boutonne" value="Soumettre la saisie">
</form>
	...
	if ($Nom!=""){
		if($Date!=""){
			if ($Description!=""){
				if ($Photo!=""){
					if($Auteur!=""){
						$sq="INSERT INTO publication(Contenu_texte, Date, chemin, Description, nb_like, Auteur) VALUES('$Nom','$Date','$Photo','$Description',0,'$Auteur')";
