<html>
<menu>
<link href="css/PublicationSup.css" rel="stylesheet">
<div id="menu">
  <ul id="onglets">
...
<body>
	...
	<form method="post" action="PublicationSuppression.php">
		...
		<input type="submit" class=boutonsupp value="Valider la saisie">
	</form>
		...
		while($data=mysqli_fetch_assoc($res)){
			...
			if($data['Contenu_texte']==$Nom){
				if ($Nom!=""){
					...
					echo "</br>
					<input type='button' class=boutonsupp value='Verifiez' Onclick=".$destination.">
					</br>";
